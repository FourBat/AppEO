...
public class Utils {
    public static final String XUTIL_URL="http://10.40.5.54:8080/Xutils/";
    public static final String IMG_URL="http://10.40.5.54:8080/EO/";

    public static final String LOGIN_URL=XUTIL_URL+"login";
    public static final String CONTACTS_URL=XUTIL_URL+"contacts";
    public static final String DEFAULT_IMG=IMG_URL+"emotion_001.png";
    public static final String CONTACTS_MSG_URL=XUTIL_URL+"contactmsg";
    public static final String SEARCH_FRIEND_URL=XUTIL_URL+"searchfriend";
    public static final String GET_COMPANY=XUTIL_URL+"getcompany";
